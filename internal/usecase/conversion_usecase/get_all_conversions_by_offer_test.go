...
func TestGetAllConversionsByOffer(t *testing.T) {
	var offerID int64 = 1
	...
	tests := []struct {
	...
	}{
		{
			...
			before: func(f useCaseMocks) {
				...
				f.repoConversion.EXPECT().GetAllConversionsByOffer(offerID).Return([]*domain.Conversion{conversion})
			},
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			e := uc.GetAllConversionsByOffer(tt.args.req)
